...
export default function Page() {
    return (
        <div className={"flex flex-col items-center justify-center"}>
            ...
            <div className={"text-sm md:text-xl text-neutral-400 mt-4 max-w-ws md:max-w-2xl text-center mx-auto"    }>
                Collaborate, manage projects, and reach new productivity peaks. From high rises to the home office,
                the way your team works in unique - accomplish it all with Taskify.
            </div>
